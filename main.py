        ...
        if choice==1: #Создать новую папку
           ...
           os.mkdir(folder_name)
            ...
            try:
                ...
                os.remove(name_del) if os.path.isfile(name_del) == True else shutil.rmtree(name_del)
            except FileNotFoundError:
                print("Неправильно введено название файла/папки для удаления")
            ...
            try:
                ...
                shutil.copy(copy_source, copy_result) if os.path.isfile(copy_source) else shutil.copytree(copy_source, copy_result)
            except FileNotFoundError:
                print("Неправильно введено имя копируемого файла или папки")
            ...
            try:
                ...
                print("Неверно введен путь к директории")
        elif choice == 13: #
            break
        else:
